...
export const ErrorReplies = {
	...
	COMPARATOR_NOT_RUNNING: "Cannot run this command while a comparison is not in progress."
}
 ...
 */
export const defaultErrorHandle = (interaction: CommandInteraction, error: unknown | Error) => {
